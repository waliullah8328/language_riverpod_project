...
import 'package:language_riverpod_project/core/common/widgets/custom_text.dart';
import 'package:language_riverpod_project/core/utils/constants/app_sizer.dart';
import '../../../../../../core/utils/constants/image_path.dart';
import '../../../../core/utils/constants/icon_path.dart';
import '../../app_appearance_section/app_apearance/view/app_appearance_screen.dart';
                ...
                child: Column(
                  children: [
                    CustomAccountButton(iconPath: IconPath.appAppearanceIcon, title: "App Appearance",onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => AppAppearanceScreen(),));
                    },)]),
              )),
          ]
        )));
    ...
    return GestureDetector(
      ...
      child: Row(
        ...
        children: [
          ...
          SvgPicture.asset(IconPath.rightArrowIcon,height: 24.h,width: 24.w,)
